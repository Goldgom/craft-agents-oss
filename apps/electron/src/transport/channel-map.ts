...
export const CHANNEL_MAP = {
  ...
  deleteServerWorkspace: invoke(RPC_CHANNELS.server.DELETE_WORKSPACE),
  ...
  listCustomModels: invoke(RPC_CHANNELS.settings.LIST_CUSTOM_MODELS),
  ...
  clearIdleMcpRuntimes: invoke(RPC_CHANNELS.settings.CLEAR_IDLE_MCP_RUNTIMES),
  ...
  // Theme packs
  getThemePacks: invoke(RPC_CHANNELS.theme.GET_PACKS),
  getThemePacksDir: invoke(RPC_CHANNELS.theme.GET_PACKS_DIR),
  getThemePack: invoke(RPC_CHANNELS.theme.GET_PACK),
  getSelectedThemePack: invoke(RPC_CHANNELS.theme.GET_SELECTED_PACK),
  setSelectedThemePack: invoke(RPC_CHANNELS.theme.SET_SELECTED_PACK),
  getThemePackAsset: invoke(RPC_CHANNELS.theme.GET_PACK_ASSET),
  importThemePackFolder: invoke(RPC_CHANNELS.theme.IMPORT_PACK_FOLDER),
  deleteThemePack: invoke(RPC_CHANNELS.theme.DELETE_PACK),
  onThemePackChange: listener(RPC_CHANNELS.theme.PACK_CHANGED),
