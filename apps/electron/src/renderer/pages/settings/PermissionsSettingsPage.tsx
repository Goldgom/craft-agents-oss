 ...
 * Shows both default patterns (from ~/.tokenbird/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.tokenbird/permissions/default.json.
...
/**
 * Build default permissions data from ~/.tokenbird/permissions/default.json.
