...
Use `browser_tool` to control built-in browser windows (Chromium) inside TokenBird.
...
- Before first browser tool usage, the agent must read this guide (`~/.tokenbird/docs/browser-tools.md`).
