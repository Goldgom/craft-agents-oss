...
Use this skill for structured workspace configuration changes outside sources, skills, agents, and automations. Read the matching document in `~/.tokenbird/docs/` before editing: `labels.md`, `statuses.md`, `permissions.md`, `tool-icons.md`, or `skills.md` as applicable.
