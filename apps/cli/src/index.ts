#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for TokenBird server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running TokenBird server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for TokenBird server
