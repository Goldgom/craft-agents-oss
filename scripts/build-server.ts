#!/usr/bin/env bun
/**
 * Build script for standalone TokenBird server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for TokenBird
...
# TokenBird Server — convenience entry point
