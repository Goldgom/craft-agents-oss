 ...
 *
 * File locations:
 * - Workspace: ~/.tokenbird/workspaces/{slug}/permissions.json
 * - Per-source: ~/.tokenbird/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.tokenbird/permissions/
 * Reads env var dynamically so tests can override via TOKENBIRD_CONFIG_DIR.
 */
...
/**
 * Load default permissions from ~/.tokenbird/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.tokenbird/permissions/default.json)
   ...
   * These come from ~/.tokenbird/permissions/default.json
   */
