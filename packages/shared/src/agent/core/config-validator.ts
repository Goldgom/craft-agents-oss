...
/**
 * TokenBird specific config files that have known schemas.
 */
const CRAFT_AGENT_CONFIG_PATTERNS = [
  // Main config
  /\.tokenbird\/config\.json$/,
  // Preferences
  /\.tokenbird\/preferences\.json$/,
  // Source configs
  /\.tokenbird\/workspaces\/[^/]+\/sources\/[^/]+\/config\.json$/,
  // Permissions
  /\.tokenbird\/workspaces\/[^/]+\/permissions\.json$/,
  /\.tokenbird\/permissions\/[^/]+\.json$/,
  // Theme
  /\.tokenbird\/workspaces\/[^/]+\/theme\.json$/,
  // Statuses
  /\.tokenbird\/workspaces\/[^/]+\/statuses\/config\.json$/,
  // Labels
  /\.tokenbird\/workspaces\/[^/]+\/labels\.json$/,
  // Tool icons
  /\.tokenbird\/tool-icons\/tool-icons\.json$/,
];
...
export class ConfigValidator {
  ...
  /**
   * Check if a file path is a TokenBird config file.
   *
   * @param filePath - Path to check
   * @returns true if this is a TokenBird config
   */
