 ...
 * TokenBird's AgentEvent format for UI compatibility.
 *
...
/**
 * Maps Pi SDK events to TokenBirdEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more TokenBirdEvents.
   */
