 ...
 *
 * Watched paths:
 * - ~/.tokenbird/config.json - Main app configuration
 * - ~/.tokenbird/preferences.json - User preferences
 * - ~/.tokenbird/theme.json - App-level theme overrides
 * - ~/.tokenbird/themes/*.json - Preset theme files (app-level)
 * - ~/.tokenbird/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.tokenbird/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.tokenbird/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.tokenbird/permissions/)
