 ...
 * Setup guidance lives in the bundled docs under ~/.tokenbird/docs/.
 *
 * The agent should consult the bundled local docs when creating sources.
 */
 ...
 * Setup guides live in the bundled docs under ~/.tokenbird/docs/.
 */
