 ...
 * @param workspaceRootPath - Absolute path to workspace folder (e.g., ~/.tokenbird/workspaces/xxx)
...
export async function createSource(
  ...
  // Service-specific guidance is provided by bundled docs under ~/.tokenbird/docs/.
