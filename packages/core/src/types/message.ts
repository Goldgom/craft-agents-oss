...
export type ErrorCode =
  ...
  | 'content_policy_blocked' // Prompt blocked by provider content moderation / usage policy
  ...
  | 'android_claude_unsupported' // Claude native binary can't run on Android (glibc vs bionic libc)
  | 'unknown_error';
